...
public class Worklet: AnySerializable {
  ...
  public func schedule(on runtime: WorkletRuntime) {
    ExpoWorkletsDiscovery.requireProvider().schedule(serializable.jsSerializable, runtime: runtime)
  }
  ...
  public func schedule(on runtime: WorkletRuntime, arguments: [Any]) {
    ExpoWorkletsDiscovery.requireProvider().schedule(serializable.jsSerializable, runtime: runtime, arguments: arguments)
  }
  ...
  public func execute(on runtime: WorkletRuntime) {
    ExpoWorkletsDiscovery.requireProvider().execute(serializable.jsSerializable, runtime: runtime)
  }
  ...
  public func execute(on runtime: WorkletRuntime, arguments: [Any]) {
    ExpoWorkletsDiscovery.requireProvider().execute(serializable.jsSerializable, runtime: runtime, arguments: arguments)
  }
